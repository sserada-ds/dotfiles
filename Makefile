...
claude: ## Claude Codeをインストールし設定を適用
c: claude
...
ollama: ## Ollama (ローカルLLM) をインストールして設定
ol: ollama
...
uv: ## uv (Pythonパッケージマネージャー) をインストール
